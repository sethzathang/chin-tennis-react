...
const MOCK_LIVE = [
  { id: 1, tournament: 'Summer Slam', match: 'John Smith vs Mike Johnson', date: 'Today', url: 'https://facebook.com/live/123' },
  { id: 2, tournament: 'Coastal Classic', match: 'Sarah Williams vs Emma Davis', date: 'Today', url: 'https://facebook.com/live/124' },
  { id: 3, tournament: 'Mountain Masters', match: 'David Lee vs James Wilson', date: 'Today', url: 'https://facebook.com/live/125' },
];
      ...
      <View style={styles.container}>
        <View style={styles.headerRow}>
          ...
          <TouchableOpacity style={styles.createButton} onPress={() => setModalVisible(true)}>
            <ThemedText type="defaultSemiBold" style={styles.createButtonText}>Create Live Session</ThemedText>
          </TouchableOpacity>
        </View>
        {/* Current Live Event */}
